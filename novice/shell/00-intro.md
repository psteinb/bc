...
it figures out what commands to run and orders the computer to execute them. By the way, this is the reason why it is called *the shell*: it encloses the operating system in order to hide it's complexity and make it simple to interact with.
